...
<?php while ($artistQuery->have_posts()): $artistQuery->the_post(); ?>
    <?php if (function_exists('get_field')): ?>
        ...
        <main class="artist-single" id="main-content">
            ...
            <section id="project-img" class="content-section-padding">
            ...
            <div class="positioner">
                <img src="<?php bloginfo('template_url'); ?>/assets/parallax/single-artist/sa-ellipse-headline.png" alt="" class="parallax" id="sa-ellipse-headline">
            </div>

            <div class="positioner">
                <img src="<?php bloginfo('template_url'); ?>/assets/parallax/pink-dot.svg" alt="" class="parallax ellipse-dot" id="sa-ellipse-dot-1">
            </div>

            <section id="project-info-grid" class="content-section-padding">

                <div id="primary-info" class="info-area">

                    <h2 id="project-title" class="h1"><?php echo $project_title ?></h2>

                    <h3 id="project-artists"><?php echo $displayName ?></h3>
            ...
            <?php endif ?> -->
                ...
                <div id="description" class="info-area">
                    ...
                    <div id="project">
                        ...
                        <?php
                        if ($project_link) {
                            echo "<a id='project-link' target='blank' href='" . esc_url($project_link['url']) . "'>" . esc_attr($project_link['title']) . "</a>";
                        }
                        ?>
            ...
            <div class="positioner">
                <img src="<?php bloginfo('template_url'); ?>/assets/parallax/single-artist/sa-ellipse-cell.png" alt="" class="parallax ellipse-cell" id="sa-ellipse-cell">
            </div>

            <div class="positioner">
                <img src="<?php bloginfo('template_url'); ?>/assets/parallax/pink-dot.svg" alt="" class="parallax ellipse-dot" id="sa-ellipse-dot-2">
            </div>

            <div class="positioner">
                <img src="<?php bloginfo('template_url'); ?>/assets/parallax/pink-dot.svg" alt="" class="parallax ellipse-dot" id="sa-ellipse-dot-3">
            </div>
                ...
                <?php if ($prevID): ?>
                    <a href="<?= get_the_permalink($prevID) ?>" rel="prev">
                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="56" height="56" rx="28" fill="#95AC56" />
                            <path d="M27.8571 34L35 27L27.8571 20M35 27H19" stroke="#0D4400" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>
                <?php endif; ?>
            </div>
